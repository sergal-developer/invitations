...
export class Graduation {
    ...
    setupGallery() {
        ...
        document.documentElement.style.setProperty("--numGraduates", `${boxItems.length}`);
        const list = getComputedStyle(document.documentElement).getPropertyValue("--numGraduates");
        let step = 0;
    ...
    _getPercentScroll() {
        return Math.round(((document.documentElement.scrollTop + window.innerHeight) /
